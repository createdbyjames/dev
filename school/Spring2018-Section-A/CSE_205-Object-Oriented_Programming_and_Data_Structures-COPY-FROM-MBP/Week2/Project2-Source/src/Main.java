...
public class Main {
    ...
    private ArrayList<Student> readFile() throws FileNotFoundException {
        ...
        try {
            ...
            File file = new File("/Users/jamesjkim/Desktop/CSE_205-Object-Oriented_Programming_and_Data_Structures/Week2/Project2-Source/src/p02-students.txt");
    ...
    private OnCampusStudent readOnCampusStudent(Scanner pIn) {
        ...
        OnCampusStudent oncampuStudent = new OnCampusStudent(id, lastName, firstName);
        ...
        if (residenceStatus.equals("R")) {
            oncampuStudent.setResidency(true);
        } else {
            oncampuStudent.setResidency(false);
        }

        oncampuStudent.setProgramFee(fee);
        oncampuStudent.setCredit(credits);

        return oncampuStudent;
    }
